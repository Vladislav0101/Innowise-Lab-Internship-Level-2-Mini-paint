  ...
  <div class="wrapper">
    ...
    <div class="information-box">
      <div class="header-info-edit">
        <HeaderInformation :userEmail="email" />
        <div @click="setEditMode" class="go-edit">
          <svg
            height="25"
      ...
      <AccountInfo :information="userAccountInfo" v-if="!isEdit"></AccountInfo>
      <CreateAccountInfo
        :information="userAccountInfo"
        @changeIsEditMode="isEdit = !isEdit"
        v-else
      ></CreateAccountInfo>
    </div>
  </div>
...
import HeaderInformation from "@/components/Account/HeaderInformation.vue";
import AccountInfo from "@/components/Account/AccountInfo.vue";
import CreateAccountInfo from "@/components/Account/CreateAccountInfo.vue";
...
export default Vue.extend({
  ...
  components: { Header, HeaderInformation, AccountInfo, CreateAccountInfo },

  computed: {
    ...mapGetters(["email", "userAccountInfo"])
  }
});
</script>
